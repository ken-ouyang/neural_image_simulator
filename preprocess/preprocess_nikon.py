...
def get_bayer(path):
    ...
    bayer=raw.raw_image_visible.astype(np.float32)[8:4032, 8:6056]
...
def process_data(input_dir, output_dir, image_size)
    ...
    all_list = []
    all_list.append(["path","time","iso","aperture","wb","noiseprofile"])
    isp_list = []
    isp_list.append(["path","AnalogBalance", 
                                "ColorMatrix1", "ColorMatrix2", "ForwardMatrix1", "ForwardMatrix2", "AsShotNeutral",
                                "CameraCalibration1", "CameraCalibration2", 'BaselineExposure',  "ColorTemperatureAuto",
    ...
    for path in input_files:
        ...
        with exiftool.ExifTool() as et:
            ...
            exif_dict = et.get_tags(("AnalogBalance", "ColorMatrix1", "ColorMatrix2", "ForwardMatrix1", "ForwardMatrix2", 
                                ...
                                "ColorTemperatureAuto","ProfileHueSatMapDims", "ProfileLookTableDims", "Make", "NoiseProfile","FNumber"), path[:-4]+".dng")
        ...
        for i in isp_list[0][1:17]:
            ...
            elif i=="ColorTemperatureAuto":
                params_isp_list.append(exif_dict["MakerNotes:ColorTemperatureAuto"])
            else:
